...
<form name="form1" method="post" action="">
    <p>
    <input type="hidden" name="encrypt" id="encrypt" value="${flash.encrypt}" />
    <input type="hidden" name="message" id="message" value="${flash.message}" />
    <input type="hidden" name="gumDetails" id="gumDetails" value="${flash.gumDetails}" />

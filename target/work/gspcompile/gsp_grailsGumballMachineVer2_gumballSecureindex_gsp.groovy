...
class gsp_grailsGumballMachineVer2_gumballSecureindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/gumballSecure/index.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1416973015912L
